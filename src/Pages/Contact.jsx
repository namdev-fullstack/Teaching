...
const ContactPage = () => {
  ...
  const handleZaloClick = () => {
    window.open('https://zalo.me/0358326643', '_blank');
  };
    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%]">
      ...
      >
        <div className="container max-w-4xl mx-auto">
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 transform transition-all duration-500 hover:shadow-[#6366f1]/10 border border-blue-200/50">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="flex-1  md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-4 mb-6">
                    ...
                    <div>
                      <h4 className="text-xl  font-semibold text-gray-800">Zalo</h4>
                      <p className="text-gray-600">Liên hệ trực tiếp</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center  md:justify-start gap-3">
                      ...
                      <span className="text-gray-700 font-medium">Tư vấn miễn phí</span>
                    </div>
                    <div className="flex items-center  md:justify-start gap-3">
                      <Sparkles className="w-5 h-5 text-green-500" />
                      <span className="text-gray-700 font-medium">Đăng ký khóa học</span>
                    </div>
                    <div className="flex items-center  md:justify-start gap-3">
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center gap-2 bg-blue-50 rounded-full px-4 py-2 border border-blue-200">
                ...
                <span className="text-gray-700 text-sm">Trả lời trong vòng 5 phút</span>
              </div>
            </div>
          </div>
        </div>
