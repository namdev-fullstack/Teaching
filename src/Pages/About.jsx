...
import { FileText, Code, Award, Globe, ArrowUpRight, Sparkles, UserCheck, GraduationCap, BookOpen, Users, Heart, Star, TvMinimalPlay, Target, Brain, Laptop, Lightbulb, NotebookPen  } from "lucide-react"
import AOS from 'aos'
             ...
             <div className="text-center text-gray-800 p-6">
              ...
              <div className="flex justify-center gap-3 mb-4">
               ...
               <div className="inline-flex items-center gap-2 bg-blue-50 rounded-full px-3 py-1 border border-blue-200">
                 ...
                 <span className="text-xs text-gray-700">2+ Năm Kinh Nghiệm</span>
               </div>
            </div>
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            {/* Services Section */}
               ...
               <h3 className="text-xl font-semibold text-gray-800">Dịch vụ gia sư:</h3>
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                 <div className="flex items-center gap-3 p-3 rounded-lg bg-white/80 border border-blue-200/50 shadow-sm">
                   <Code className="w-5 h-5 text-blue-500" />
                   <span className="text-gray-700 text-sm">Python Programming</span>
                 </div>
                 <div className="flex items-center gap-3 p-3 rounded-lg bg-white/80 border border-blue-200/50 shadow-sm">
                 ...
                 <div className="flex items-center gap-3 p-3 rounded-lg bg-white/80 border border-blue-200/50 shadow-sm">
                   ...
                   <span className="text-gray-700 text-sm">Giáo trình chi tiết</span>
                 </div>
                   <div className="flex items-center gap-3 p-3 rounded-lg bg-white/80 border border-blue-200/50 shadow-sm">
                   <NotebookPen  className="w-5 h-5 text-indigo-400" />
                   <span className="text-gray-700 text-sm">Bài tập thực hành</span>
                 </div>
                 <div className="flex items-center gap-3 p-3 rounded-lg bg-white/80 border border-blue-200/50 shadow-sm">
                   <UserCheck className="w-5 h-5 text-orange-500" />
                   <span className="text-gray-700 text-sm">Nhận xét sau buổi học</span>
                 </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-white/80 border border-blue-200/50 shadow-sm">
                   <TvMinimalPlay className="w-5 h-5 text-blue-500" />
                   <span className="text-gray-700 text-sm">Thuyết trình sản phẩm cuối khóa</span>
                 </div>
               </div>
             </div>
